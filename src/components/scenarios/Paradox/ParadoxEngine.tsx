...
export const ParadoxEngine: React.FC = () => {
    ...
    // Recursive simulation loop using setTimeout for better control
    useEffect(() => {
        ...
        const loop = () => {
            ...
            // Schedule next tick
            timeoutId = setTimeout(loop, 1200); // 1.2 second delay (slower for safety)
        };
    ...
    return (
        <div className="bg-slate-900 border border-slate-700 rounded-2xl p-8 max-w-2xl mx-auto shadow-2xl relative overflow-hidden">
            ...
            <div className="absolute top-2 left-2 text-[10px] text-slate-700 font-mono">v1.2-STABLE</div>
            ...
            <div className="relative z-10 flex flex-col items-center gap-8">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="h-16 w-1 bg-slate-700 my-2 relative">
                        {isRunning && (
                            <div className="w-1 h-full bg-yellow-500/50 absolute left-1/2 -translate-x-1/2" />
                        )}
                    </div>
                ...
                {stepCount > 5 && (
                    ...
                    >
                        ...
                        <span className="text-sm font-bold">¡ALERTA! Bucle infinito detectado.</span>
                    </div>
                )}
            </div>
        </div>
